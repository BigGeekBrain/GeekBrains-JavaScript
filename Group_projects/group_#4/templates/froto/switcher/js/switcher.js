			...
			"<div class='switcherContents'>"+
				...
				"<div class='switcherContent patterens'>"+
					...
					"<ul class='demo-content demo-pattern'>"+
						...
						"<li data-name='gnrl_pattern' data-value='bg1'><img alt='' src='switcher/images/patterns/bg1.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg2'><img alt='' src='switcher/images/patterns/bg2.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg3'><img alt='' src='switcher/images/patterns/bg3.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg4'><img alt='' src='switcher/images/patterns/bg4.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg5'><img alt='' src='switcher/images/patterns/bg5.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg6'><img alt='' src='switcher/images/patterns/bg6.png'></li>"+

						"<li data-name='gnrl_pattern' data-value='bg7'><img alt='' src='switcher/images/patterns/bg7.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg8'><img alt='' src='switcher/images/patterns/bg8.png'></li>"+

						"<li data-name='gnrl_pattern' data-value='bg9'><img alt='' src='switcher/images/patterns/bg9.png'></li>"+

						"<li data-name='gnrl_pattern' data-value='bg10'><img alt='' src='switcher/images/patterns/bg10.png'></li>"+

						"<li data-name='gnrl_pattern' data-value='bg11'><img alt='' src='switcher/images/patterns/bg11.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg12'><img alt='' src='switcher/images/patterns/bg12.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg13'><img alt='' src='switcher/images/patterns/bg13.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg14'><img alt='' src='switcher/images/patterns/bg14.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg15'><img alt='' src='switcher/images/patterns/bg15.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg16'><img alt='' src='switcher/images/patterns/bg16.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg17'><img alt='' src='switcher/images/patterns/bg17.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg18'><img alt='' src='switcher/images/patterns/bg18.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg19'><img alt='' src='switcher/images/patterns/bg19.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg20'><img alt='' src='switcher/images/patterns/bg20.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg21'><img alt='' src='switcher/images/patterns/bg21.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg22'><img alt='' src='switcher/images/patterns/bg22.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg23'><img alt='' src='switcher/images/patterns/bg23.png'></li>"+
						
						"<li data-name='gnrl_pattern' data-value='bg24'><img alt='' src='switcher/images/patterns/bg24.png'></li>"+
   ...
   //-- controlling the position of switcher --
	...
	function pointer_pattern(pattern_style){
		if (jQuery(".active-layout").attr("data-value") == "boxed" || jQuery(".active-layout").attr("data-value") == "boxed2") {
			jQuery("body").css("background","url(switcher/images/patterns/"+pattern_style+".png) repeat");
		}
	}
	...
	function pointer_color(color_style,color_style_2){
		if (color_style != "skins") {
			jQuery(".style-5 .ribbon").attr("src","switcher/images/ribbon-"+color_style+".png");
			jQuery('head').append('<style type="text/css">.push_options{background:#'+color_style_2+'}</style>');
		}else if (color_style == "skins") {
			jQuery(".style-5 .ribbon").attr("src","switcher/images/ribbon-pink.png");
			jQuery('head').append('<style type="text/css">.push_options{background:#'+color_style_2+'}</style>');
		}
		jQuery('head').append('<link rel="stylesheet" href="switcher/css/'+color_style+'.css">');
	}
